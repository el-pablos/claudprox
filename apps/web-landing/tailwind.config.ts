...
// Light-first, tenang, enterprise. Enam warna dasar Octet jadi sumber kebenaran:
//   #ebedf1 Bright Grey, #d4d8df Shy Blunt, #acadb1 Grey Timber Wolf,
//   #706f70 Smoked Pearl, #353536 Jet Black, #080808 Reversed Grey.
// Turunan tonal (#e8eaef, #c8cbd1, #5b5a5b) dibuat dengan campuran berakar enam
// warna tersebut demi kontras WCAG AA pada permukaan terang.
// Namespace lama `ctos` dan `brand` di-remap ke palet netral supaya komponen
// existing ikut berubah tanpa putus (back-compat instan, bukan stale).
const config: Config = {
